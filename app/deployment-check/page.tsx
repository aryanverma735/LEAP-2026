      ...
      <div className="card mt-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p>
              Ensure your Firebase configuration in <code>app/firebase/config.ts</code> is correct and that the Firebase
              project exists.
            </p>
          </div>
          ...
          <div>
            ...
            <p>Make sure all required environment variables are set in your deployment environment.</p>
          </div>

          <div>
            <h3 className="font-semibold text-lg">Firebase Security Rules</h3>
            <p>Verify that your Firebase security rules allow the operations your application needs to perform.</p>
          </div>
        </div>
      </div>
    </div>
